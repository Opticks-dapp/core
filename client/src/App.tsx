      ...
      <main className="flex">
        <nav className="h-screen flex flex-col bg-sky-800 p-10">
          <div className="flex items-center gap-x-2 mb-20">
            <img src="https://avatars.githubusercontent.com/u/191602027?s=200&v=4" alt="logo" className="size-10 brightness-0 invert" />
            <h2 className="font-medium text-white text-2xl">Opticks</h2>
          </div>

          <div className="text-white flex flex-col gap-y-10">
            {navItems.map((item, key) => (
              <div className="flex items-center gap-x-4 opacity-60 duration-200 cursor-pointer hover:opacity-100" key={key}>
          ...
          <div className="">
            <div className="flex font-medium text-white gap-x-7 text-xs">
              <p className="flex items-center gap-x-1"><Icon.Book size={13} /> Docs</p>
              <p className="flex items-center gap-x-1"><Icon.Scale size={13} /> Disclaimer</p>
            </div>
          </div>
        </nav>
